...
#define SOIL_PIN 2  // ADC pin (adjust if needed)
...
int SOIL_DRY = 3500;  // example - replace with your measured dry value
int SOIL_WET = 1200;  // example - replace with your measured wet value
