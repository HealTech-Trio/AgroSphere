// screens/Analysis/IrrigationOptimization/IrrigationOptimizationScreen.js
...
import IrrigationHistoryTab from './IrrigationHistoryTab';

const IrrigationOptimizationScreen = ({ navigation, route }) => {
  ...
  const toolConfig = {
    ...
    lightGradient: ['rgba(255, 152, 0, 0.6)', 'rgba(255, 152, 0, 0.27)'],
    icon: 'water-drop',
  };
  ...
  const handleAnalyze = async () => {
    if (!connectedDevice || connectionStatus !== 'connected') {
      Alert.alert(
        'IoT Device Required',
        'Please connect to your IoT device before analyzing irrigation needs. Go to the IoT screen to connect.',
        [
    ...
    if (!selectedFarm) {
      Alert.alert(
        'Farm Required',
        'Please select a farm to optimize irrigation and fertilization.',
        [{ text: 'OK' }]
      );
      return;
    }
    ...
    if (!selectedCrop) {
      Alert.alert(
        'Crop Required',
        'Please select a crop to get specific irrigation and fertilizer recommendations.',
        [{ text: 'OK' }]
      );
      return;
    }
    ...
    try {
      ...
      const response = await ApiService.optimizeIrrigation(iotData, farmData, cropData);
      ...
      Alert.alert(
        'Analysis Failed',
        error.message || 'Unable to complete irrigation optimization. Please try again.',
        [{ text: 'OK' }]
      );
    }
  };
        ...
        >
            ...
            <View style={styles.warningCard}>
              ...
              <View style={styles.warningContent}>
                ...
                <Text style={styles.warningText}>
                  Connect to your IoT device to get real-time data for accurate irrigation optimization.
                </Text>
                {/* <TouchableOpacity 
            ...
            {loadingFarms ? (
              ...
              <View style={styles.emptyFarmsCard}>
                ...
                <Text style={styles.emptyFarmsText}>
                  Add your farms in the Profile section to start optimizing irrigation.
                </Text>
                <TouchableOpacity 
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoTextContainer}>
              <Text style={styles.infoTitle}>Optimization Process</Text>
              <Text style={styles.infoText}>
                • Real-time IoT sensor data is required{'\n'}
                • Farm location affects weather-based recommendations{'\n'}
                • Crop-specific irrigation and fertilizer advice{'\n'}
          ...
          <TouchableOpacity
            style={[
              ...
              (!isDeviceConnected || !selectedFarm || !selectedCrop) && styles.analyzeButtonDisabled
            ]}
            onPress={handleAnalyze}
            disabled={!isDeviceConnected || !selectedFarm || !selectedCrop}
            activeOpacity={0.7}
          >
            <LinearGradient
              colors={
                isDeviceConnected && selectedFarm && selectedCrop
                  ? toolConfig.gradient
                  : ['#E0E0E0', '#D0D0D0']
              }
            ...
            >
              ...
              <Text style={styles.analyzeButtonText}>
                Optimize Irrigation & Fertilizer
              </Text>
            </LinearGradient>
          </TouchableOpacity>
...
export default IrrigationOptimizationScreen;